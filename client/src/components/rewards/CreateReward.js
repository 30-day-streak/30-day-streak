      ...
      <div>
        {this.state.showForm && (
          <div className="create-challenge-page">
            ...
            >
              <Link to={`/rewards`} className="cancel-x">
                <img
                  src="/images/Transparent_Xpink.png"
                  alt="cancel"
                  width="20px"
                />
              </Link>
              <div className="create-challenge-header">
                ...
                <p>
                  Check out what <a href="#">other users have added</a> or see
                  if there is something you like on
                  <a
                    href="https://www.developgoodhabits.com/reward-yourself/"
                    target="_blank"
                  >
                    {' '}
                    this list{' '}
                  ...
                  or{' '}
                  <a
                    href="https://organisemyhouse.com/reward-yourself/"
                    target="_blank"
                  >
                    this one
                  </a>
